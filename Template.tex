...
The following document is build as a Template for LateX by Sascha Bilert. I tried to implement my most frequently used latex packages. If you have any comments please contact me under:
